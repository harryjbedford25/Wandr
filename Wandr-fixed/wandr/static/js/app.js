...
function initMap() {
  map = L.map("map", { zoomControl: true, maxZoom: 19 }).setView([48.5, 10], 5);
  ...
  // Only add train layer if the checkbox is checked (fix: was always added on init)
  const trainCheckbox = document.getElementById("layer-trains");
